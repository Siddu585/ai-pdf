...
function InstantDropContent() {
    ...
    const setupWebRTC = async (ws: WebSocket, isSender: boolean) => {
        logDebug(`Setting up RTCPeerConnection (v01.5.4 Reliable Superfast Stream), isSender: ${isSender}`);
    ...
    const transferFileP2PParallel = (file: File, index: number, total: number) => {
        return new Promise<void>((resolve) => {
            ...
            const startParallelBurst = async () => {
                ...
                const HIGH_WATER_MARK = 2 * 1024 * 1024; // 2MB per channel (16MB total)
                const LOW_WATER_MARK = 512 * 1024;       // 512KB per channel (4MB total)
        ...
        <div className="min-h-screen bg-background flex flex-col font-sans">
            ...
            <main className="flex-1 container mx-auto px-4 max-w-4xl py-12">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xs text-muted-foreground font-medium tracking-widest uppercase mb-2">v01.5.4 Reliable Superfast Stream</p>
